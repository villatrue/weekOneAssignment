...
public class CreateAuthor {
	...
	public static void main(String[] args) {
		...
		try(BufferedWriter bufStream = new BufferedWriter(new FileWriter("./resources/inputFiles/authors.txt", true))){
				
				bufStream.append(addedAuthor.getAuthorId().toString()+"\t"+addedAuthor.getAuthorName());
				bufStream.append("\n");
